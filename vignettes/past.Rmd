...
merged_data <- merge_data(demo_association_file, demo_effects_file, "mlm")
LD <- parse_LD(demo_linkage_disequilibrium_file) # parse_LD can take gzip-compressed files or plain text
genes <-parse_SNP(merged_data, LD, demo_genes_file, 1000, 0.8, 4)
rugplots_data <- analyze_pathways(genes, demo_pathways_file, 5, "increasing", 1000, 4)
