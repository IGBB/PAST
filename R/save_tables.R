...
#' write_enrichment_data(enrichment_data, tempdir())
write_enrichment_data <- function(enrichment_data,
  ...
  data.table::fwrite(enrichment_data[get(significance_measure) <= significance_cutoff],
                     file = output_path
  )
}